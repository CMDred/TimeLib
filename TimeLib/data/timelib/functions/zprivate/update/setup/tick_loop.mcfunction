...
execute if score #TimeLib.PlayerHead TimeLib matches 0 store success score #TimeLib.PlayerHead TimeLib if data block 29999983 0 29999983 Items[0].tag.SkullOwner.Properties
