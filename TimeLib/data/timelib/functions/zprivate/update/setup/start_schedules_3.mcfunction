...
$execute if score #TimeLib.Settings.SavingsTimeChecks TimeLib matches 2 run schedule function timelib:zprivate/daylight_savings_time_checks/timer_1h $(NextHourStart)t
