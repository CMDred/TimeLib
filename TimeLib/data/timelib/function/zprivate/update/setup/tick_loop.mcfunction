...
execute if score #TimeLib.CommandBlock TimeLib matches 0 store success score #TimeLib.CommandBlock TimeLib run data modify storage timelib:zprivate cmd_block.Output set from block 29999983 2 29999983 LastOutput.text
