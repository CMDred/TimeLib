...
execute if score #UnixLib_Settings_SavingsTimeChecks UnixLib matches 1 run return run tellraw @s [{"text":"🕒 UnixLib >> ","color":"#2DE1E1"},{"text":"This setting is already enabled.","color":"red"}]
