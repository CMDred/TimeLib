...
execute unless score #UnixLib_Settings_RealtimeTracking UnixLib matches 1 run return run tellraw @s [{"text":"🕒 UnixLib >> ","color":"#2DE1E1"},{"text":"This setting is already selected.","color":"red"}]
scoreboard players reset #UnixLib_Settings_RealtimeTracking
tellraw @s "\n\n\n\n\n\n\n\n\n\n\n\n\n"
