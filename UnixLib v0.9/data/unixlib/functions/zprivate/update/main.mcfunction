#Get Unix Timestamp
execute store success score #UnixLib_Check UnixLib run data modify storage unixlib:b64 decode.data set from block 29999983 0 29999983 Items[0].tag.SkullOwner.Properties.textures[0].Value
...
execute if score #UnixLib_Check UnixLib matches 1 run data modify storage unixlib:b64 decode.input.0 set string storage unixlib:b64 decode.data 24 28
execute if score #UnixLib_Check UnixLib matches 1 run data modify storage unixlib:b64 decode.input.1 set string storage unixlib:b64 decode.data 28 32
execute if score #UnixLib_Check UnixLib matches 1 run data modify storage unixlib:b64 decode.input.2 set string storage unixlib:b64 decode.data 32 36
execute if score #UnixLib_Check UnixLib matches 1 run data modify storage unixlib:b64 decode.input.3 set string storage unixlib:b64 decode.data 36 40
execute if score #UnixLib_Check UnixLib matches 1 run function unixlib:zprivate/update/b64/decode with storage unixlib:b64 decode.input
