...
execute if score #TimeLib.Settings_RealtimeTracking TimeLib matches 1 run return run tellraw @s [{"text":"🕒 TimeLib >> ","color":"#2DE1E1"},{"text":"This setting is already selected.","color":"red"}]
scoreboard players set #TimeLib.Settings_RealtimeTracking TimeLib 1
tellraw @s "\n\n\n\n\n\n\n\n\n\n\n\n\n"
