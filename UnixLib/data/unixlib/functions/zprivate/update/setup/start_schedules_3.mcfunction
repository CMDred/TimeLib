#Set schedules
execute if score #UnixLib_Settings_RealtimeTracking UnixLib matches 1 run schedule function unixlib:zprivate/singleplayer/timer_1s 19t
execute if score #UnixLib_Settings_RealtimeTracking UnixLib matches 2 run schedule function unixlib:zprivate/timer_1s 19t
