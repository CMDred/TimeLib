...
execute if score #UnixLib_CommandBlock UnixLib matches 0 store success score #UnixLib_CommandBlock UnixLib run data modify storage unixlib:zprivate cmd_block.Output set from block 29999983 2 29999983 LastOutput
