...
data modify storage unixlib:zprivate cmd_block.Time.Hour set string block 29999983 1 29999983 LastOutput 10 12
function unixlib:zprivate/daylight_savings_time_checks/set_cmd_block_time with storage unixlib:zprivate cmd_block.Time
...
execute store result storage unixlib:zprivate calc.Result.NextDayStart int 1 run scoreboard players operation #UnixLib_NextDayStart UnixLib_Second -= #UnixLib_CommandBlock UnixLib_Hour
function unixlib:zprivate/daylight_savings_time_checks/start_schedules with storage unixlib:zprivate calc.Result